      ...
      <main>
        <section>
          <div className={clsx('layout min-h-[60vh] pt-10')}>
            <div>
              <Link className="my-4 text-hl" href="/">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4">
                  <p className="text-hl">
                    ...
                    <Link className="text-fg" href="https://monkeytype.com">
                      monkeytype
                    </Link>
                  </p>
                ...
                <ul className="space-y-1">
                  <li>
                    <Link className="text-fg" href="/">
                      home
                    </Link>
                  </li>
                  <li>
                    <Link className="text-fg" href="/leaderboard">
                      leaderboard
                    </Link>
                  </li>
                  <li>
                    <Link className="text-fg" href="/account">
                      account
                    </Link>
                  </li>
                  <li>
                    <Link className="text-fg" href="/multiplayer">
                      multiplayer
                    </Link>
                  </li>
                </ul>
