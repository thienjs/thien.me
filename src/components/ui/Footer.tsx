  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-center mx-auto pb-10 text-gray-600 dark:text-gray-400">
        <Link href='https://github.com/thienjs'><GithubIcon className= 'h-8 w-8 mx-3'/></Link>
        <Link href='https://discord.com/thien#4420'><DiscordIcon className='h-8 w-8 mx-3'/></Link>
        <Link href='https://twitter.com/thientsx'><TwitterIcon className='h-8 w-8 mx-3'/></Link>
        <Link href='emailto:hi@thien.me'><EmailIcon className='h-8 w-8 mx-3'/></Link>
        <Link href='https://linkedin.com/thienjs'><LinkedinIcon className='h-8 w-8 mx-3'/></Link>
      </div>
    </div>
  );
};
